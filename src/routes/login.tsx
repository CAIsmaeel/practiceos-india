        ...
        <div className="text-center mb-8">
          {logoUrl ? (
            <img
              src={logoUrl}
              alt={firmName}
              className="w-16 h-16 rounded-xl object-contain bg-white p-1 mx-auto mb-4 shadow-lg"
            />
          ) : (
          ...
          <h1 className="text-2xl font-display font-bold text-sidebar-foreground">{firmName}</h1>
