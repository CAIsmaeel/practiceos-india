    ...
    <div className="space-y-6">
      ...
      {!isLoading && grouped.length === 0 && (
        <div className="bg-white border border-slate-200 rounded-lg p-12 text-center">
          ...
          {completedCount > 0 && (
            <button onClick={() => setShowCompleted(true)} className="text-blue-500 text-sm mt-2 hover:underline">
              ...
              {group.tasks.map((t) => (
                <li key={t.id} className="px-5 py-3 flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    {t.assigned_to && <p className="text-xs text-slate-500">Assigned: {t.assigned_to}</p>}
                    {t.due_date && (
